...
inertia = constMatrix(
    [[0.00578574, 0.0, 0.0], [0.0, 0.01938108, 0.0], [0.0, 0.0, 0.02476124]],
    "inertia",
)
...
des_end_eff = stack_two_vectors(
    reader_end_eff.vector, reader_end_eff_1.vector, 36, 24
)
