...
pos_des_fl_fr = mul_double_vec_2(
    osc.sout, unit_vector, "sine_des_position_front"
)
pos_des_hl_hr = mul_double_vec_2(
    osc.sout, unit_vector, "sine_des_position_hind"
)
...
control_torques = quad_impedance_controller(
    robot,
    pos_des_fl_fr,
    pos_des_fl_fr,
    pos_des_hl_hr,
