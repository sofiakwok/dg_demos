"""
@package dg_demos
@file teststand/simulations/stiffness_measurement.py
...
from dg_demos.teststand.controllers.stiffness_measurement import get_controller
...
def simulate(with_gui=True):
    ...
    robot = get_robot(init_sliders_pose=init_sliders_pose, with_gui=with_gui)
    ...
    ctrl.set_vertical_stiffness(100.0)
